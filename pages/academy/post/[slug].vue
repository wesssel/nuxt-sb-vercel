<template>
  <div v-if="story && settings">
    <Post
      :backText="settings.academy_back"
      :backLink="settings.academy_back_link"
      class="mb-32"
    />
...
await actions.loadAcademy({ slug: `post/${route.params.slug || ''}` })

// Load categories
await actions.loadAcedemyCategories({
